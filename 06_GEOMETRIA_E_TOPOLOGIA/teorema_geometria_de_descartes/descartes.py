...
def descartes(k1, k2, k3):
    """
    Aplica a fórmula de teorema_geometria_de_descartes para encontrar as duas soluções possíveis de k4
...
print(curvaturas)
print("\nResultados usando o Teorema de teorema_geometria_de_descartes:\n")

# Aplicar o Teorema de teorema_geometria_de_descartes a cada grupo de 3 curvaturas consecutivas
