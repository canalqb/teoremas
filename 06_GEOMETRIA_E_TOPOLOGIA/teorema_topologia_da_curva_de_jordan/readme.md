...
* [2. Script `teorema_curva_jordan_gerador.py`](#2-script-jordan_regions_generatorpy)
...
## 2. Script `teorema_curva_jordan_gerador.py`
...
```bash
python teorema_curva_jordan_gerador.py
```
