...
def private_key_to_wif_compressed(k: int) -> str:
    ...
    # Codifica em base58
    wif = base58.b58encode(extended_with_flag + checksum)
    return wif.decode()
...
def main():
    ...
    # Salva JSON
    json_path = r"C:/Users/Qb/Desktop/ola/07. Teoremas_Matematica/teoremas/01_CRIPTOGRAFIA_E_CURVAS_ELIPITICAS/teorema_criptografia_secp256k1/puzzle71_hash160_71bit_sample.json"
    with open(json_path, 'w') as f:
        json.dump(hash160_71bit, f, indent=2)
    print(f"  JSON salvo: {json_path}")
    
    # Salva TXT
    txt_path = r"C:/Users/Qb/Desktop/ola/07. Teoremas_Matematica/teoremas/01_CRIPTOGRAFIA_E_CURVAS_ELIPITICAS/teorema_criptografia_secp256k1/puzzle71_wif_71bit_sample.txt"
    with open(txt_path, 'w') as f:
        f.write('\n'.join(wif_71bit))
    print(f"  TXT salvo: {txt_path}")
    ...
    print("Exemplo: 0|5HpHagT65TZzG1PH3CSu63k8DbpvD8s5ip4nGA7FHbQxX5dxNam")
